...
<!-- audio to be played -->
<audio autoplay>
  <source src="music.ogg" autoplay/>
  <source src="audio/msu.mp3">
</audio>
...
<div class="border1">
    ...
    <div class="sidenav">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" >
            ...
            <a href="index.php"><input type="submit" value="Logout" class="btn btn-primary btn-sm" ></a>
        </nav>
    </div>
    ...
    <div id="wrapper">
        ...
        <div class="infor">
            ...
            <div class="info">
                <h6><img src="images/msubg.jpg">New main admin is now located at Main Campus gate.rcnrmcoinconconrcoenrcencoenc eceocjeceonrc erocjnoeccnrec\
                    ecmnecec0ence ceojjcneccec-ecmecmecmemc-ecmem
                    ecmnecec0ence ceojjcneccec-ecmecmecmemc-ecmem
                    ecmnecec0ence ceojjcneccec-ecmecmecmemc-ecmem
                    ecmnecec0ence ceojjcneccec-ecmecmecmemc-ecmem</h6>
            </div>
        </div>
        <!--        notification side-->
        <div class="right_eN">
